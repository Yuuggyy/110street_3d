    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center',
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 44 }}>
          ...
          <h1 style={{ fontSize: 32, fontWeight: 700, color: '#F5F5F0', letterSpacing: '0.04em' }}>
            110 Street
          </h1>
              ...
              <div key={lbl}>
                ...
                <input type={i === 0 ? 'email' : 'password'}
                  ...
                  style={{ width: '100%', padding: '13px 16px',
                    ...
                    borderRadius: 12, color: '#F5F5F0', fontSize: 15, fontFamily: 'inherit', outline: 'none',
                  }}
                />
              </div>
            ))}
          ...
          <div key={cmd.id} style={{ background:'#fff', borderRadius:14, padding:'18px 20px',
            ...
            <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
              {STATUT_NEXT[cmd.statut] && <button onClick={()=>nextStatut(cmd)} style={{ padding:'7px 14px', borderRadius:8, border:'none', cursor:'pointer',
                background:`linear-gradient(135deg,${C.primary},${C.primaryMid})`, color:'#F5F5F0', fontSize:12, fontWeight:600 }}>
  ...
  return (
    <div>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:24,flexWrap:'wrap',gap:12}}>
        ...
        <button onClick={openNew} style={{padding:'9px 18px',borderRadius:10,border:'none',cursor:'pointer',background:`linear-gradient(135deg,${C.primary},${C.primaryMid})`,color:'#F5F5F0',fontSize:13,fontWeight:600}}>+ Ajouter</button>
      </div>
      {loading?<div style={{display:'flex',justifyContent:'center',padding:60}}><div className="spinner"/></div>
    ...
    <div>
      ...
      <div style={crd}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:20,flexWrap:'wrap'}}>
          <div style={{width:90,height:90,borderRadius:'50%',overflow:'hidden',background:'rgba(0,0,0,0.05)',border:`2px solid ${C.border}`,display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>
            {preview?<img src={preview} alt="Logo" style={{width:'100%',height:'100%',objectFit:'cover'}}/>:<span style={{fontSize:32}}>🏙️</span>}
          </div>
          <div style={{display:'flex',flexDirection:'column',gap:10}}>
      ...
      <div style={crd}>
        ...
        <div style={{display:'flex',gap:12,flexWrap:'wrap'}}>
          <input value={nomRestaurant} onChange={e=>setNom(e.target.value)} style={{...inp,flex:1,minWidth:200}} placeholder="110 Street"/>
      ...
      <div style={crd}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:12}}>
          ...
          <button onClick={handleChangePassword} disabled={pwdLoading} style={{padding:'12px 20px',borderRadius:10,border:'none',cursor:'pointer',background:`linear-gradient(135deg,${C.primary},${C.primaryMid})`,color:'#F5F5F0',fontWeight:700,fontSize:14,alignSelf:'flex-start'}}>{pwdLoading?'⏳ Modification…':'🔐 Mettre à jour'}</button>
        </div>
      </div>
    </div>
  );
    ...
    <div style={{display:'flex',minHeight:'100vh',background:'#FAFAFA'}}>
      <aside style={{width:230,flexShrink:0,background:C.primary,display:'flex',flexDirection:'column',padding:'28px 0',position:'fixed',top:0,left:0,bottom:0,zIndex:100,boxShadow:'4px 0 24px rgba(0,0,0,0.18)'}}>
        <div style={{padding:'0 24px 24px',borderBottom:'1px solid rgba(255,255,255,0.12)',marginBottom:12}}>
          ...
          <h2 style={{fontSize:18,color:'#F5F5F0',fontWeight:700,lineHeight:1.2}}>{"110 Street"}</h2>
