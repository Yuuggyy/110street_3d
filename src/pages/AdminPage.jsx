...
const C = {
  ...
  danger:      '#C0392B',
  warning:     '#D4891A',
  goldDeep:    '#836806', // high-contrast accent for text on white/cream backgrounds
...
function LoginForm({ onLogin }) {
  ...
  return (
    <div style={{
      ...
      background: `linear-gradient(160deg, ${C.primary} 0%, #111111 50%, #030303 100%)`,
      padding: 20,
    }}>
            ...
            <div>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} required autoFocus
                style={{
                  ...
                  background: 'rgba(255,255,255,0.07)', border: `1.5px solid rgba(245,197,24,0.25)`,
                  borderRadius: 12, color: C.beige, fontSize: 15, fontFamily: 'inherit',
                  outline: 'none', transition: 'border-color 0.2s',
                }}
                onFocus={e => e.target.style.borderColor = C.gold}
                onBlur={e => e.target.style.borderColor = 'rgba(245,197,24,0.25)'}
              />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 11, fontWeight: 600, color: C.gold, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 8 }}>
...
function CommandesTab() {
  ...
  const badgeStyle = (statut) => ({
    recue:     { bg: `rgba(245,197,24,0.15)`, color: C.goldDeep },
    ...
    <div>
      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <input value={nomRestaurant} onChange={e => setNom(e.target.value)} style={{ ...inputStyle, flex: 1, minWidth: 200 }} placeholder="110 Street" />
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: C.cream }}>
      ...
      <aside style={{
        ...
        {/* Header sidebar */}
        <div style={{ padding: '0 24px 24px', borderBottom: `1px solid rgba(245,197,24,0.18)`, marginBottom: 12 }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 20, color: C.beige, fontWeight: 700, lineHeight: 1.2 }}>110 Street</h2>
        ...
        {/* Footer sidebar */}
        <div style={{ padding: '12px 16px', borderTop: `1px solid rgba(245,197,24,0.12)`, display: 'flex', flexDirection: 'column', gap: 8 }}>
          <button onClick={() => window.open('/', '_blank')} style={{
            width: '100%', padding: '9px 14px', borderRadius: 10, border: `1px solid rgba(245,197,24,0.25)`,
